...
| `statewave` (Python SDK) | Sync + async clients, typed exceptions, auth, batch, receipts + label / policy methods | 1.5.0 | Apache-2.0 |
| `@statewavedev/sdk` (TypeScript SDK) | Typed errors, auth, batch, ESM, receipts + label / policy methods | 1.5.0 | Apache-2.0 |
...
## Test counts (as of v1.5.0)

| Project | Tests | Framework |
|---|---|---|
| Server | 944 | pytest + pytest-asyncio |
| `statewave` (Python SDK) | 80 | pytest |
| `@statewavedev/sdk` (TypeScript SDK) | 50 | vitest |
| `@statewavedev/connectors-*` | 800 | vitest |
